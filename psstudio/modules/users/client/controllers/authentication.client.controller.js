...
angular.module("users").controller("AuthenticationController", ["$scope", "$state", "$http", "$location", "$window", "Authentication", "PasswordValidator","ProjectCore",
  function ($scope, $state, $http, $location, $window, Authentication, PasswordValidator,ProjectCore) {
    ...
    $scope.signup = function (isValid) {
      ...
      $http.post("/api/auth/signup", $scope.credentials).success(function (response) {
        ...
        $state.go("projects", $state.previous.params);
