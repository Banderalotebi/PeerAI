...
RED.tabs = (function() {
    function createTabs(options) {
        ...
        if (options.addButton && typeof options.addButton === "function") {
            ...
            //console.log(ul)
            var addButton = $("<div class=\"red-ui-tab-button\" style=\"display: none;\"><a href=\"#\"><i class=\"fa fa-plus\"></i></a></div>").appendTo(wrapper);
        ...
        if (options.scrollable) {
            ...
            scrollLeft = $("<div class=\"red-ui-tab-button red-ui-tab-scroll red-ui-tab-scroll-left\" style=\"display: none;\"><a href=\"#\" style=\"display:none;\"><i class=\"fa fa-caret-left\"></i></a></div>").appendTo(wrapper).find("a");
            scrollLeft.on("mousedown",function(evt) { scrollEventHandler(evt,"-=150"); }).on("click",function(evt){ evt.preventDefault();});
            scrollRight = $("<div class=\"red-ui-tab-button red-ui-tab-scroll red-ui-tab-scroll-right\" style=\"display: none;\"><a href=\"#\" style=\"display:none;\"><i class=\"fa fa-caret-right\"></i></a></div>").appendTo(wrapper).find("a");
